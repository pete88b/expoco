# AUTOGENERATED! DO NOT EDIT! File to edit: 10b_viseme_tabular_capture_session.ipynb (unless otherwise specified).
...
def _setup_variables(expression_id):
    ...
    path = Path(f'data/viseme_tabular_capture_sessions/{now()}_{expression_id}')
