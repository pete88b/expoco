...
__all__ = ['mp_face_mesh', 'model_path', 'viseme_classifier', 'FacePoint', 'FacePoints', 'FacePointHelper', 'calibrate',
           'move', 'calibration', 'StopExpocoException', 'stop_expoco', 'Command', 'commands', 'command_map',
           'SleepHelper', 'run_main']
...
# Cell
model_path = Path('data/viseme_image_dataset_20211202_082908/model_20211202_143854/resnet_3_256_256.onnx')
